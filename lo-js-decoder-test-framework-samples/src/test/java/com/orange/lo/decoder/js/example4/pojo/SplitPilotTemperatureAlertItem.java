...
@Data
@OutputPojo
public class SplitPilotTemperatureAlertItem extends SplitPilotHeaderItem {
    ...
    public class Value {
        ...
        @FieldDescription(description = "temperatureThresholdStatus")
        public ThresholdStatus temperatureThresholdStatus;
	    ...
	    public class ThresholdStatus  {
	    	 @FieldDescription(description = "Threshold1 status. Values can be: Threshold Reached or Threshold Not Reached.")
	    	 public String threshold1;
	    	 @FieldDescription(description = "Threshold2 status. Values can be: Threshold Reached or Threshold Not Reached.")
